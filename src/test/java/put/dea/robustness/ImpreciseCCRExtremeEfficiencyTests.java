...
public class ImpreciseCCRExtremeEfficiencyTests extends ImpreciseCCRTestBase {
    ...
    @Test
    public void verifySuperEfficiencyWithWeightConstraints() {
        addWeightConstraints();
        ImpreciseCCRExtremeEfficiency extremeEfficiency = new ImpreciseCCRExtremeEfficiency(1.1, 0.01);
        var superEff = extremeEfficiency.superEfficiencyForAll(data);
        var expectedValues = new double[]{
                0.23322, 0.39074, 0.252716, 0.035156, 0.112771, 0.779398,
                0.215203, 0.202671, 0.106397, 2.149333, 0.305657, 0.058544, 0.15684,
                0.246263, 0.370208, 0.279226, 32230.018209, 0.090419, 0.333356, 11.833108,
                0.319469, 0.082285, 0.128088, 0.157855, 1.262884, 0.346613, 14.386708
        };
        Assertions.assertArrayEquals(expectedValues,
                superEff.stream().mapToDouble(x -> x).toArray(),
                1e-6);
    }
}
